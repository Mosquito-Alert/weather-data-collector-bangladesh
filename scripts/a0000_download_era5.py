...
for this_year in range(2024, currentYear+1):
    ...
    for this_month in these_months:
        for this_variable in [
            ...
            c.retrieve(
                ...
                os.path.expanduser('~/research/weather-data-collector-bangladesh/data/output/era5_' + str(this_year) + '_' + "{month:02d}".format(month=this_month) + '_' + this_variable + '.grib')
            )
